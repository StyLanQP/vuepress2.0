<template><h1 id="medium-zoom" tabindex="-1"><a class="header-anchor" href="#medium-zoom" aria-hidden="true">#</a> medium-zoom</h1>
...
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code>File not found</code></pre><div class="line-numbers"></div></div><h2 id="composition-api" tabindex="-1"><a class="header-anchor" href="#composition-api" aria-hidden="true">#</a> Composition API</h2>
<h3 id="usemediumzoom" tabindex="-1"><a class="header-anchor" href="#usemediumzoom" aria-hidden="true">#</a> useMediumZoom</h3>
<ul>
<li>
<p>详情：</p>
<p>返回该插件使用的 <code>Zoom</code> 实例，便于你直接使用实例上的 <a href="https://github.com/francoischalifour/medium-zoom#methods" target="_blank" rel="noopener noreferrer">methods<ExternalLinkIcon/></a> 。</p>
