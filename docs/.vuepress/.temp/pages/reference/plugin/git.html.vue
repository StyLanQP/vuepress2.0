...
<p>默认主题的 <RouterLink to="/reference/default-theme/config.html#lastupdated">lastUpdated</RouterLink> 和 <RouterLink to="/reference/default-theme/config.html#contributors">contributors</RouterLink> 就是由该插件支持的。</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h2 id="git-仓库" tabindex="-1"><a class="header-anchor" href="#git-仓库" aria-hidden="true">#</a> Git 仓库</h2>
...
<h2 id="页面数据" tabindex="-1"><a class="header-anchor" href="#页面数据" aria-hidden="true">#</a> 页面数据</h2>
