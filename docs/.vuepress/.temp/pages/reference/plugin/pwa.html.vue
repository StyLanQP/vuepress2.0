<template><h1 id="pwa" tabindex="-1"><a class="header-anchor" href="#pwa" aria-hidden="true">#</a> pwa</h1>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div><h2 id="web-app-manifests" tabindex="-1"><a class="header-anchor" href="#web-app-manifests" aria-hidden="true">#</a> Web App Manifests</h2>
...
<p>你需要将你的 Manifest 文件和图标放置在 <RouterLink to="/guide/assets.html#public-%E6%96%87%E4%BB%B6">Public 目录</RouterLink> 下。在下述的示例中，我们假设你正在使用默认的 Public 目录 <code>.vuepress/public</code> 。</p>
<ol>
...
<p>你还需要通过 <RouterLink to="/reference/config.html#head">head</RouterLink> 配置项来设置一些标签，用来 <a href="https://developer.mozilla.org/en-US/docs/Web/Manifest#deploying_a_manifest_with_the_link_tag" target="_blank" rel="noopener noreferrer">部署你的 Manifest 文件<ExternalLinkIcon/></a> 。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h2 id="配置项" tabindex="-1"><a class="header-anchor" href="#配置项" aria-hidden="true">#</a> 配置项</h2>
<p>该插件的配置项可以接收 workbox-build 中 <a href="https://developers.google.com/web/tools/workbox/reference-docs/latest/module-workbox-build#.generateSW" target="_blank" rel="noopener noreferrer">generateSW 方法<ExternalLinkIcon/></a> 除了 <code>globDirectory</code> 和 <code>swDest</code> 以外的所有参数。</p>
...
<ul>
<li>对于用户，你可以配合我们提供的 <RouterLink to="/reference/plugin/pwa-popup.html">pwa-popup</RouterLink> 插件一起使用。</li>
...
<li>
<p>详情：</p>
<p>生成的 Service Worker 文件路径，该路径是 <RouterLink to="/reference/config.html#dest">dest</RouterLink> 目录的相对路径。</p>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br></div></div><h3 id="useskipwaiting" tabindex="-1"><a class="header-anchor" href="#useskipwaiting" aria-hidden="true">#</a> useSkipWaiting</h3>
<ul>
<li>参数：</li>
</ul>
<table>
