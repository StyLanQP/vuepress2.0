<template><h1 id="node-api" tabindex="-1"><a class="header-anchor" href="#node-api" aria-hidden="true">#</a> Node API</h1>
...
<p>详情：</p>
<p>该 Page 的摘要。</p>
<p>如果一个 Markdown 文件中包含一个 <code>&lt;!-- more --&gt;</code> 注释，那么该注释上方的内容都会被作为摘要提取并渲染。</p>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div><h3 id="headers" tabindex="-1"><a class="header-anchor" href="#headers" aria-hidden="true">#</a> headers</h3>
<ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#markdown-extractheaders">配置 &gt; markdown.extractHeaders</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="data" tabindex="-1"><a class="header-anchor" href="#data" aria-hidden="true">#</a> data</h3>
<ul>
<li>类型： <code>PageData</code></li>
</ul>
...
<li><RouterLink to="/reference/plugin-api.html#extendspage">插件 API &gt; extendsPage</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/frontmatter.html#date">Frontmatter &gt; date</RouterLink></li>
</ul>
</li>
</ul>
...
<p>详情：</p>
<p>该 Page 的依赖。</p>
<p>举例来说，如果在页面中导入了代码片段，那么被导入文件的绝对路径就会被添加到 <code>deps</code> 中。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#markdown-importcode">配置 &gt; markdown.importCode</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="hoistedtags" tabindex="-1"><a class="header-anchor" href="#hoistedtags" aria-hidden="true">#</a> hoistedTags</h3>
<ul>
<li>
<p>类型： <code>string[]</code></p>
</li>
<li>
<p>详情：</p>
<p>该 Page 中提升的 Tags。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#markdown-hoisttags">配置 &gt; markdown.hoistTags</RouterLink></li>
</ul>
</li>
</ul>
<h3 id="links" tabindex="-1"><a class="header-anchor" href="#links" aria-hidden="true">#</a> links</h3>
<ul>
<li>类型： <code>MarkdownLink[]</code></li>
</ul>
...
<p>如果该 Page 不是来自于 Markdown 源文件，那么该属性会为 <code>null</code> 。</p>
</li>
<li>
<p>示例：</p>
<ul>
...
<p>它是根据页面的 Markdown 源文件相对路径、以及用户配置的 <code>locales</code> 的键推断得到的。</p>
</li>
<li>
<p>示例：</p>
<ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#locales">配置 &gt; locales</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/frontmatter.html#permalink">Frontmatter &gt; permalink</RouterLink></li>
<li><RouterLink to="/reference/frontmatter.html#permalinkpattern">Frontmatter &gt; permalinkPattern</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/frontmatter.html#routemeta">Frontmatter &gt; routeMeta</RouterLink></li>
<li><a href="https://next.router.vuejs.org/zh/api/#meta" target="_blank" rel="noopener noreferrer">vue-router &gt; API 参考 &gt; RouteRecordRaw &gt; meta<ExternalLinkIcon/></a></li>
</ul>
</li>
</ul>
