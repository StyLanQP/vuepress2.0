<template><h1 id="命令行接口" tabindex="-1"><a class="header-anchor" href="#命令行接口" aria-hidden="true">#</a> 命令行接口</h1>
<NpmBadge package="@vuepress/cli" />
<p>VuePress 命令行接口是由 <a href="https://www.npmjs.com/package/@vuepress/cli" target="_blank" rel="noopener noreferrer">@vuepress/cli<ExternalLinkIcon/></a> 包提供的。它是 <a href="https://www.npmjs.com/package/vuepress" target="_blank" rel="noopener noreferrer">vuepress<ExternalLinkIcon/></a> 包的依赖之一，当然你也可以单独安装它。</p>
...
<p>设置环境变量 <code>DEBUG=vuepress*</code> 可以启用调试日志。</p>
</div>
...
<p>将你的 VuePress 站点构建成静态文件，以便你进行后续<RouterLink to="/guide/deployment.html">部署</RouterLink>。</p>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code>Usage:
