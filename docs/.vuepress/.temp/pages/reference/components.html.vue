<template><h1 id="内置组件" tabindex="-1"><a class="header-anchor" href="#内置组件" aria-hidden="true">#</a> 内置组件</h1>
...
<p>页面 Key 是页面路由的 <a href="https://next.router.vuejs.org/zh/api/#name-2" target="_blank" rel="noopener noreferrer">name<ExternalLinkIcon/></a> 。如果没有传入 <code>pageKey</code> Prop ，它会渲染当前路由下的页面。</p>
<p>该组件主要是为了开发主题时使用。在绝大多数情况下你不会用到它。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/node-api.html#key">Node API &gt; Page 属性 &gt; key</RouterLink></li>
</ul>
</li>
</ul>
</template>
