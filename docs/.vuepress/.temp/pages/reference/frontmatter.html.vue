...
<p>详情：</p>
<p>页面的创建日期。</p>
<p>应按照 <code>yyyy-MM-dd</code> 的格式来指定日期，或者遵循 <a href="https://yaml.org/type/timestamp.html" target="_blank" rel="noopener noreferrer">YAML Timestamp Type<ExternalLinkIcon/></a> 。</p>
</li>
<li>
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/node-api.html#date">Node API &gt; Page 属性 &gt; date</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#description">配置 &gt; description</RouterLink></li>
</ul>
</li>
</ul>
...
<li>参考：
<ul>
<li><RouterLink to="/reference/config.html#head">配置 &gt; head</RouterLink></li>
</ul>
</li>
</ul>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/config.html#lang">配置 &gt; lang</RouterLink></li>
<li><RouterLink to="/reference/node-api.html#lang">Node API &gt; Page 属性 &gt; lang</RouterLink></li>
</ul>
</li>
</ul>
...
<p>在 <code>.vuepress/clientAppEnhance.ts</code> 文件中注册一个布局组件：</p>
<div class="language-typescript ext-ts line-numbers-mode"><pre v-pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> defineClientAppEnhance <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">'@vuepress/client'</span>
...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>在 Frontmatter 中设置自定义布局：</p>
<div class="language-markdown ext-md line-numbers-mode"><pre v-pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="permalink" tabindex="-1"><a class="header-anchor" href="#permalink" aria-hidden="true">#</a> permalink</h2>
<ul>
<li>
<p>类型： <code>string</code></p>
</li>
...
<li><RouterLink to="/reference/node-api.html#permalink">Node API &gt; Page 属性 &gt; permalink</RouterLink></li>
</ul>
</li>
</ul>
...
<li>默认值 <code>0000-00-00</code> 。</li>
</ul>
</li>
<li>
<p>示例 1 ：</p>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><p>那么页面的永久链接将会是 <code>2021/01/03/foo-bar.html</code> 。</p>
<ul>
<li>
<p>示例 2 ：</p>
...
<span class="token punctuation">---</span></span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>那么页面的永久链接将会是 <code>2021/01/03/bar-baz.html</code> 。</p>
<ul>
<li>参考：
<ul>
...
<ul>
<li>
<p>类型： <code>Record&lt;string, unknown&gt;</code></p>
</li>
<li>
<p>详情：</p>
<p>附加到页面路由的自定义数据。</p>
...
<p>参考：</p>
<ul>
<li><RouterLink to="/reference/node-api.html#title">Node API &gt; Page 属性 &gt; title</RouterLink></li>
</ul>
</li>
</ul>
</template>
