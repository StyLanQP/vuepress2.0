<template><h1 id="theme" tabindex="-1"><a class="header-anchor" href="#theme" aria-hidden="true">#</a> Theme</h1>
...
<h2 id="community-theme" tabindex="-1"><a class="header-anchor" href="#community-theme" aria-hidden="true">#</a> Community Theme</h2>
<p>Community users have created lots of theme and published them to <a href="https://www.npmjs.com/search?q=keywords:vuepress-theme" target="_blank" rel="noopener noreferrer">NPM<ExternalLinkIcon/></a>. You should check the theme's own documentation for detailed guide.</p>
...
<h2 id="local-theme" tabindex="-1"><a class="header-anchor" href="#local-theme" aria-hidden="true">#</a> Local Theme</h2>
...
<div class="language-text ext-text line-numbers-mode"><pre v-pre class="language-text"><code>└─ docs
   ...
   │  └─ config.js
   └─ README.md
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><p>Then, set the <RouterLink to="/reference/config.html#theme">theme</RouterLink> option to the absolute path of the <RouterLink to="/advanced/theme.html#theme-entry">theme entry</RouterLink> to use it:</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><p>Next, refer to <RouterLink to="/advanced/theme.html">Advanced &gt; Writing a Theme</RouterLink> for how to write your own theme.</p>
</template>
