<template><h1 id="page" tabindex="-1"><a class="header-anchor" href="#page" aria-hidden="true">#</a> Page</h1>
...
<p>A markdown file could contain a <a href="https://yaml.org/" target="_blank" rel="noopener noreferrer">YAML<ExternalLinkIcon/></a> frontmatter. The frontmatter must be at the top of the Markdown file and must be wrapped with a couple of triple-dashed lines. Here is a basic example:</p>
...
<p>With the power of <a href="https://github.com/markdown-it/markdown-it" target="_blank" rel="noopener noreferrer">markdown-it<ExternalLinkIcon/></a> and Vue template syntax, the basic Markdown can be extended a lot. Next, check out the <RouterLink to="/guide/markdown.html">Markdown</RouterLink> guide for all the extensions of Markdown in VuePress.</p>
</template>
